...
export function VoteThermoGauge({
  ...
  return (
    ...
    >
      <div className="vote-thermo-gauge__tube">
        <div className="vote-thermo-gauge__ticks" aria-hidden>
          <span />
          <span />
          <span />
          <span />
      ...
      <div className="vote-thermo-gauge__bulb" aria-hidden>
        <span
          className="vote-thermo-gauge__bulb-fill"
