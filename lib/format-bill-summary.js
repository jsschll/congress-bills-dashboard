...
/** Soft word cap for punchy Action Match summaries (≤2 sentences / ~30 words). */
function clampPlainSummaryWords(text = "", maxWords = 30) {
  ...
  const plain_summary =
    clampPlainSummaryWords(
      completeSentences(raw.plain_summary || raw.what_it_does || "", {
        ...
        completeSentences(summary, { maxSentences: 2, maxChars: 200 }) ||
        summary,
      30
    ) || summary;
  const yea_impact =
