...
- MAXIMUM LENGTHS: card_summary ≤2 short complete sentences (~55 words). takeaway = 1 crisp headline line. key_points = exactly 3 short bullets. pro_argument / con_argument = 1 complete sentence each. onboarding_question ≤20 words, one complete question.
...
Write at an 8th-grade reading level. Ban jargon and empty filler ("provides funding for", "addresses", "supports", "improves") unless followed by a specific fact from the text. Always finish every sentence and noun phrase. Keep every field punchy and scannable. Return structured tool input only.`;
}
