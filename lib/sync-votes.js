...
RULES:
- BAN JARGON: Eliminate references to tax codes, administrative databases (e.g. WEAMS), statutory sub-clauses, and legalisms. Do not use terms like 'appropriations', 'reconciliation', 'pursuant to title II', 'procedural motion', or raw amendment numbers in the summary text.
- MAXIMUM LENGTH: 2 short sentences (~35 words max) for plain_summary.
...
Format your response in plain, direct English. Use the Parent Bill + Amendment context to understand what package this change sits inside, but never paste amendment numbers or process jargon into the output. Do not invent programs, funding amounts, repeals, or bans that are not clearly in the source text. No slogans and no fear-mongering.
  ...
  input_schema: {
    ...
    properties: {
      ...
      plain_summary: {
        type: "string",
        description:
          "At most 2 short sentences and ≤35 words. Real-world impact on wallet, rights, or community — no jargon.",
      },
      yea_impact: {
        type: "string",
        description:
...
- plain_summary: ≤2 sentences AND ≤35 words — real-world impact on wallet, rights, or community; ban jargon
