...
const BREAKDOWN_FIELD_ERROR_RE =
  /card_summary|takeaway|key_points|pro_argument|con_argument/i;

const IMPACT_FIELD_ERROR_RE =
  /short_title|plain_summary|what_it_does|yea_impact|nay_impact|is_key_vote|card_summary|takeaway|key_points|pro_argument|con_argument/i;
