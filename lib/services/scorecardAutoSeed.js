...
/**
 * Ensure attendance placeholders exist. Campaign finance is synced from
 * OpenFEC on read (see fecFinance.js) — do not insert identical party fakes.
...
async function ensureDonorAndAttendancePlaceholders(supabase, profile) {
  ...
  // Intentionally skip campaign_finance inserts here. Identical party
  // placeholders made every Republican (etc.) look the same in Follow the Money.
