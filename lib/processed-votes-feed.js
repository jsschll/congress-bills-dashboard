...
function mapProcessedVoteToFeedItem(row = {}) {
  ...
  const whatItDoes = String(row.what_it_does || "").trim();
...
const PROCESSED_VOTES_SELECT = [
  ...
  "yea_label",
  "nay_label",
  // Prefer these after migration-action-match-impact-fields.sql.
  // Keep optional in mapProcessedVoteToFeedItem so older DBs still load.
  "bill_number",
  "legislation_number",
  "bill_type",
  "result",
