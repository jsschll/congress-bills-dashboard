...
function mapProcessedVoteToFeedItem(row = {}) {
  ...
  return {
    ...
    key_points: row.key_points || row.keyPoints || row.key_impacts || null,
    keyPoints: row.key_points || row.keyPoints || row.key_impacts || null,
    key_impacts: row.key_impacts || row.key_points || row.keyPoints || null,
    keyImpacts: row.key_impacts || row.key_points || row.keyPoints || null,
    primaryCategory,
