...
-- Politicians feature (also in migration-politicians.sql + migration-politicians-levels.sql)
...
create index if not exists politicians_office_title_idx on public.politicians (office_title);
...
-- Decision makers (also in migration-decision-makers.sql)
